...
const TRANSLATIONS: TranslationsMap = {
  en: {
    ...
    messages_no_found: 'No messages found.',
    messages_reply_sent: 'Reply sent successfully ✅',
    messages_reply_failed: 'Failed to send reply ❌',
    messages_reply_error: 'Error while sending reply ❌',
    ...
    settings_enable_2fa: 'Enable Two-Factor Authentication',
    settings_save_changes: 'Save Changes',
    settings_logout: 'Logout',
    settings_delete_account: 'Delete Account',
    settings_preferences: 'Preferences',
    settings_default_download_path: 'Set Default Download Path',
    settings_preferred_categories: 'Set Preferred Software Categories',
    settings_auto_update: 'Enable Auto Update',
    settings_show_widgets: 'Show Dashboard Widgets',
    email: 'Email',
    message: 'Message',
    status: 'Status',
    ...
    send: 'Send Reply',
    sending: 'Sending...',
    reply_subject: 'Reply from Manager Dashboard',
  ...
  am: {
    ...
    hero_secure_your: 'በላቀ መፍትሄዎች ',
    hero_systems_with: 'ስርዓቶቻችሁን',
    hero_advanced_solutions: 'አስተማማኝ አድርጉ',
    ...
    manager_dashboard: 'መናገሪ ዳሽቦርድ',
    settings: 'ቅንብሮች',
    logout: 'ውጣ',
    toggle_theme: 'ጭራሽ ለውጥ',
    messages: 'መልዕክቶች',
    reply: 'መልስ',
    delete: 'ሰርዝ',
    ...
    messages_email: 'ኢሜይል',
    messages_content: 'መልእክት',
    messages_status: 'ሁኔታ',
    messages_created: 'ተፈጠረበት ጊዜ',
    messages_actions: 'እርምጃዎች',
    messages_mark_read: 'እንደተነበበ ምልክት',
    messages_delete: 'ሰርዝ',
    messages_reply: 'መልስ',
    messages_sending: 'በመላክ ላይ...',
    messages_send_reply: 'መልስ ላክ',
    messages_cancel: 'ደርስ',
    messages_no_found: 'መልእክት አልተገኘም።',
    messages_reply_sent: 'መልስ ተልኳል ✅',
    messages_reply_failed: 'መልስ መላክ አልተሳካም ❌',
    messages_reply_error: 'ስህተት ተከስቷል ❌',

    // --- Manager Settings ---
    settings_title: 'መቼት',
    settings_profile: 'መገለጫ',
    settings_notifications: 'ማሳወቂያዎች',
    settings_email_alerts: 'ኢሜይል ማሳወቂያዎች',
    settings_security: 'ደህንነት',
    settings_change_password: 'የይለፍ ቃል ቀይር',
    settings_enable_2fa: 'ሁለት ደረጃ ማረጋገጫ አንቃ',
    settings_save_changes: 'ለውጦችን አስቀምጥ',
    settings_logout: 'ውጣ',
    settings_delete_account: 'መለያን ሰርዝ',
    settings_preferences: 'ምርጫዎች',
    settings_default_download_path: 'የነባር የማውረድ መንገድ አዘጋጅ',
    settings_preferred_categories: 'የተመረጡ ሶፍትዌር ምድቦች አዘጋጅ',
    settings_auto_update: 'ራስ በራስ አዘምን አንቃ',
    settings_show_widgets: 'ዳሽቦርድ መደቦች አሳይ',
    email: 'ኢሜይል',
    message: 'መልዕክት',
    status: 'ሁኔታ',
    created_at: 'ተፈጠረበት ጊዜ',
    actions: 'ተግባራት',
    loading: 'መልዕክቶች በመጫን ላይ...',
    no_messages: 'መልዕክት አልተገኘም።',
    error_loading: 'መልዕክቶችን መጫን አልተሳካም።',
    fetch_error: 'መልዕክት ማስመጣት ላይ ችግኝ ተፈጥሯል።',
    replied: 'ተመልሷል',
    seen: 'ታይቷል',
    unseen: 'አልታየም',
    reply_message: 'መልዕክት መልስ',
    type_reply: 'መልስዎን ይጻፉ...',
    cancel: 'ሰርዝ',
    send: 'መልስ ላክ',
    sending: 'በመላክ ላይ...',
    reply_subject: 'መልስ ከ መናገሪ ዳሽቦርድ',
    reply_success: 'መልስ ተላክ ✅',
    reply_failed: 'መልስ መላክ አልተሳካም ❌',
    reply_error: 'መልስ በመላክ ላይ ችግኝ ❌',
  },
}
