...
const TRANSLATIONS: TranslationsMap = {
  en: {
    ...
    manager_dashboard_subtitle: 'Overview of system activity and downloads.',
    manager_ready_download: 'Ready to Download',
    manager_ready_software: 'Ready-to-Use Software',
    manager_pending_alerts: 'Pending Alerts',
    manager_response_rate: 'Response Rate',
    manager_recent_alerts: 'Recent Security Alerts',
    manager_alert_firewall: 'Blocked suspicious IP address',
    manager_alert_access: 'Unauthorized login attempt detected',
    manager_alert_network: 'Unusual data spike detected on port 443',
    manager_system_check: 'System health check completed',
    manager_recent_activity: 'Recent Activity',
    manager_no_alerts: 'No new alerts',
  },
  am: {
    nav_gasha: 'ጋሻ',
    nav_nisir: 'ንስር',
    ...
    manager_dashboard_title: 'የአስተዳዳሪ ዳሽቦርድ',
    manager_dashboard_subtitle: 'የስርዓት እና የማውረድ እንቅስቃሴ እይታ።',
    manager_ready_download: 'ዝግጁ ለማውረድ',
    manager_ready_software: 'ዝግጁ ሶፍትዌሮች',
    manager_pending_alerts: 'በመጠባበቅ ላይ ያሉ ማሳወቂያዎች',
    manager_response_rate: 'የመልስ መጠን',
    manager_recent_alerts: 'ቅርብ የደህንነት ማሳወቂያዎች',
    manager_alert_firewall: 'ከሚጠራ አይፒ አድራሻ ተከልክሏል',
    manager_alert_access: 'ያልተፈቀደ የመግቢያ ሙከራ ተገኝቷል',
    manager_alert_network: 'በፖርት 443 ላይ ያልተለመደ የውሂብ ፍሰት ተገኝቷል',
    manager_system_check: 'የስርዓት ሁኔታ ተመርመረ',
    manager_recent_activity: 'ቅርብ እንቅስቃሴ',
    manager_no_alerts: 'አዲስ ማሳወቂያ የለም',
  },
}
